...
|---|---|---|
| `01-compute.json` | `ClusterAppCompute` | ECR, ECS, Elastic Load Balancing, EC2 *networking only*, Application Auto Scaling |
...
- **No EC2 compute or spend** — cannot launch instances, buy reserved
  instances or capacity blocks, or create VPC peering. Networking
  (VPC/subnet/route/security group/ENI) only, as required by Fargate + ALB
